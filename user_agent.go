...
func Parse(v string) (os, browser string) {
	v = strings.ToLower(v)
	...
	case strings.Contains(v, "iphone"):
		os = "iphone"
	case strings.Contains(v, "ipod"):
		os = "ipod"
	case strings.Contains(v, "ipad"):
		os = "ipad"
	case strings.Contains(v, "mac os") || strings.Contains(v, "mac_powerpc") || strings.Contains(v, "macintosh"):
		os = "mac"
	case strings.Contains(v, "windows") || strings.Contains(v, "win"):
		os = "win"
	case strings.Contains(v, "android"):
		os = "android"
	case strings.Contains(v, "linux"):
		os = "linux"
	case strings.Contains(v, "webos"):
		os = "webos"
	default:
		os = "noname"
	}
	...
	/* browser */
	switch {
	case strings.Contains(v, "chrome"):
		browser = "chrome"
	case strings.Contains(v, "msie"):
		browser = "ie"
	case strings.Contains(v, "edge"):
		browser = "edge"
	case strings.Contains(v, "firefox"):
		browser = "firefox"
	case strings.Contains(v, "opera"):
		browser = "opera"
	case strings.Contains(v, "netscape"):
		browser = "netscape"
	case strings.Contains(v, "maxthon"):
		browser = "maxthon"
	case strings.Contains(v, "konqueror"):
		browser = "konqueror"
	case strings.Contains(v, "mobile"):
		browser = "handheld"
	case strings.Contains(v, "safari"):
		browser = "safari"
	default:
		browser = "noname"
	}
