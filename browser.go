...
func (p *UserAgent) EngineName() string {
	return p.browser.Engine
}

func (p *UserAgent) EngineVersion() string {
	return p.browser.EngineVersion
}
...
func (p *UserAgent) BrowserName() string {
	return p.browser.Name
}

func (p *UserAgent) BrowserVersion() string {
	return p.browser.Version
}
